  ...
  return (
    <section id="contact" className="py-24 bg-slate-50 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="bg-primary-600 rounded-3xl shadow-xl overflow-hidden p-10 lg:p-16 text-white relative">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-12 md:gap-24 relative z-10">
            ...
            <div className="flex flex-col items-center text-center group">
              <div className="w-16 h-16 bg-primary-500 group-hover:bg-primary-400 transition-colors rounded-full flex items-center justify-center mb-6 shadow-lg">
                <Mail className="w-8 h-8" />
              </div>
              <p className="text-sm text-primary-200 font-semibold mb-2 uppercase tracking-wider">Email</p>
            ...
            <div className="flex flex-col items-center text-center group">
              ...
              <p className="text-sm text-primary-200 font-semibold mb-2 uppercase tracking-wider">Telepon / WhatsApp</p>
          ...
          <div className="mt-12 pt-12 border-t border-primary-500/50 flex flex-col items-center text-center relative z-10">
             <div className="flex items-center gap-3">
                <MapPin className="w-6 h-6 text-primary-300" />
                <p className="text-lg text-primary-100">Gresik, Jawa Timur, Indonesia</p>
             </div>
          </div>
